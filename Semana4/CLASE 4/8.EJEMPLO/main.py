...
def cargar_archivo(ruta_archivo, lista_matrices):
    try:
        ...
        for matriz_element in root.findall('matriz'):
            ...
            if lista_matrices.existe_matriz(nombre):
...
def procesar_archivo(lista_matrices):
    print("Procesando archivo...")
    actual = lista_matrices.cabeza
    if not actual:
    ...
    while True:
        ...
        actual = actual.siguiente
        if actual == lista_matrices.cabeza:
            break

def escribir_archivo_salida(ruta_salida, lista_matrices):
    try:
...
def generar_grafica(lista_matrices):
    ...
    while True:
        ...
        if actual.siguiente != lista_matrices.cabeza:
...
def menu():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            cargar_archivo(ruta_archivo, lista_matrices)
        elif opcion == "2":
            procesar_archivo(lista_matrices)
        elif opcion == "3":
            ruta_salida = input("Ingrese la ruta del archivo XML de salida: ")
            escribir_archivo_salida(ruta_salida, lista_matrices)
        elif opcion == "4":
